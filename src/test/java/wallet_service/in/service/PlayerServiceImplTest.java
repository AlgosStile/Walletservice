...
public void setUp() throws SQLException {
    ...
    public void authenticatePlayer_invalidUsernameTest() throws SQLException {
    ...
    public void AuthenticatePlayer_invalidPasswordTest() throws SQLException {
    ...
    public void getBalanceTest() throws Exception {
        ...
        playerRepository.addPlayer(new Player("username", "password"));
        playerService.credit("username", Integer.parseInt("transactionId"), 100.0);
    ...
    public void debitTest() throws Exception {
        playerRepository.addPlayer(new Player("username", "password"));
        playerService.credit("username", Integer.parseInt("transactionId1"), 100.0);

        playerService.debit("username", Integer.parseInt("transactionId2"), 50.0);
    ...
    public void debit_insufficientBalanceTest() throws SQLException {
        ...
        assertThrows(Exception.class, () -> playerService.debit("username", Integer.parseInt("transactionId"), 50.0));
    ...
    public void debit_nonexistentUser_shouldThrowExceptionTest() {
        assertThrows(Exception.class, () -> playerService.debit("nonexistentUsername", Integer.parseInt("transactionId"), 50.0));
    }
    ...
    public void credit_nonexistentUser_shouldThrowExceptionTest() {
        assertThrows(Exception.class, () -> playerService.credit("nonexistentUsername", Integer.parseInt("transactionId"), 50.0));
    }
    ...
    public void Credit_invalidUsernameTest() throws Exception {
        ...
        assertThrows(Exception.class, () -> playerService.credit("username", Integer.parseInt("transactionId"), 100.0));
    }

    @Test
    @DisplayName("Is User Authenticated Returns True When Username Matches Authenticated User Test")
    public void IsUserAuthenticated_returnsTrue_whenUsernameMatchesAuthenticatedUserTest() throws SQLException {
    ...
    public void IsUserAuthenticated_returnsFalse_whenUsernameDoesNotMatchAuthenticatedUserTest() throws SQLException {
